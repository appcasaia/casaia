...
export function generateEditToken() {
  // crypto.randomBytes es criptográficamente seguro (a diferencia de
  // Math.random, que no está pensado para generar secretos). Este token es
  // lo único que protege el link privado de edición de cada inmobiliaria,
  // así que vale la pena que sea imposible de adivinar.
